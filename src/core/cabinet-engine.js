...
import { AREA_BY_ID, GOVERNMENT_LINES, POLICY_AREAS } from '../data/simulation/policy-rules.js?v=20260926-2';
import { activeMinisters, assignMinister, campOfAxis, governingGroupIds, groupProfile, leaveMajority, parliamentInternals, reshuffleMinister, setGovernmentProgram } from './parliament-engine.js?v=20260926-2';
