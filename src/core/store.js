import { DATA_SOURCES, emptyDataset, isSelectableParty } from '../data/schema.js?v=20260924-1';
import { makeDemoParties, makeDemoState } from '../data/demo.js?v=20260924-1';
import { CAREER_LEVELS, initialCareerStatistics } from '../data/regions.js?v=20260924-1';
import { storage } from './storage.js?v=20260924-1';
import { advanceDays, formatDate } from './time.js?v=20260924-1';
import { validateNewCareerDraft } from './career-rules.js?v=20260924-1';
import { advanceCampaign, breakCampaignAlliance, createCampaign, decideCampaignEvent, negotiateCampaignAlliance, performCampaignActivity } from './campaign-engine.js?v=20260924-1';
import { activeMinisters, advanceGovernmentWeek, advanceLaw, amendLaw, assignMinister, assignPlayerGroup, canManageParliament, compromiseLaw, contestCommitteeRole, createParliamentState, enterParliament, formGovernment, leaveParliament, negotiateGovernmentSupport, negotiateLaw, normalizeParliamentState, proposeLaw, reviseGovernmentCoalition, triggerGovernmentCrisis, voteGovernmentConfidence } from './parliament-engine.js?v=20260924-1';
import { advanceWeek, alignCurrent, contestPartyRank, createGameState, joinParty, markElectionHeld, markElectionRunning, normalizeGameState, openElection, performActivity, quitParty, refreshObjectives, relationValue, resolveInboxItem, spendTime, upcomingElections } from './career-engine.js?v=20260924-1';
import { PARLIAMENT_TIME_COSTS } from '../data/simulation/career-rules.js?v=20260924-1';
