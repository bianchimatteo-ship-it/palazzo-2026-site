import { DATA_SOURCES, emptyDataset, isSelectableParty } from '../data/schema.js?v=20260924-10';
import { makeDemoParties, makeDemoState } from '../data/demo.js?v=20260924-10';
import { CAREER_LEVELS, initialCareerStatistics } from '../data/regions.js?v=20260924-10';
import { storage } from './storage.js?v=20260924-10';
import { advanceDays, formatDate } from './time.js?v=20260924-10';
import { validateNewCareerDraft } from './career-rules.js?v=20260924-10';
import { advanceCampaign, breakCampaignAlliance, createCampaign, decideCampaignEvent, negotiateCampaignAlliance, performCampaignActivity } from './campaign-engine.js?v=20260924-10';
import { activeMinisters, playerInMajority, advanceGovernmentWeek, majorityShift, advanceLaw, amendLaw, assignMinister, assignPlayerGroup, canManageParliament, compromiseLaw, contestCommitteeRole, createParliamentState, enterParliament, formGovernment, leaveParliament, negotiateGovernmentSupport, negotiateLaw, normalizeParliamentState, proposeLaw, reviseGovernmentCoalition, triggerGovernmentCrisis, voteGovernmentConfidence } from './parliament-engine.js?v=20260924-10';
import { addSituationEvent, addWorldReaction, advanceWeek, alignCurrent, contestPartyRank, createGameState, joinParty, markElectionHeld, markElectionRunning, normalizeGameState, openElection, performActivity, quitParty, refreshObjectives, relationValue, resolveInboxItem, spendTime, upcomingElections } from './career-engine.js?v=20260924-10';
import { PARLIAMENT_TIME_COSTS } from '../data/simulation/career-rules.js?v=20260924-10';
import { advanceWorld, applyWorldSignals, breakAlliance, campaignPollBonus, createWorld, normalizeWorld, proposeAlliance, setPlayerParty } from './world-engine.js?v=20260924-10';
import { advanceSociety, applyLawToSociety, calibrateWeights, createSociety, mediaEvent, normalizeSociety, regionAttention, societyMood } from './society-engine.js?v=20260924-10';
import { ACTIVITY_MEDIA, INDICATORS, ISSUE_TOPICS } from '../data/simulation/society-rules.js?v=20260924-10';
import { book, setBudgetLevel } from './finance-engine.js?v=20260924-10';
import { isPartyLeader } from './organization-engine.js?v=20260924-10';
import { selectContacts, syncContacts } from './contacts-engine.js?v=20260924-10';
