import { advanceDays } from './time.js?v=20260925-1';
import { ELECTION_MODELS } from '../data/simulation/campaign-rules.js?v=20260925-1';
import { activeMinisters, governingGroupIds, playerInMajority } from './parliament-engine.js?v=20260925-1';
import {
  ...
  SITUATION_EVENTS, WEEKLY_ACTION_POINTS, WEEKLY_ACTIVITIES, PARTY_LINES, CURRENT_LINES, PARTY_INVESTMENTS, COMMUNICATION_STYLES, CURRENT_AREAS } from '../data/simulation/career-rules.js?v=20260925-1';
import { ACTIVITY_FINANCE_CATEGORY } from '../data/simulation/finance-rules.js?v=20260925-1';
import { ELECTED_CONTRIBUTION, SELECTION_LEAD_DAYS } from '../data/simulation/organization-rules.js?v=20260925-1';
...
import { book, buyInvestment, createFinance, depositElectionFund, hasAsset, normalizeFinance, settleFinanceWeek } from './finance-engine.js?v=20260925-1';
import { advanceOrganization, applyOrgEffects, createOrganization, isPartyLeader, normalizeOrganization, treasuryBook } from './organization-engine.js?v=20260925-1';
import { advanceContacts, changeContact, contactLabel } from './contacts-engine.js?v=20260925-1';
import { HARD_CATEGORIES, difficultyId, difficultyOf } from '../data/simulation/difficulty-rules.js?v=20260925-1';
import { macroAreaOf } from '../data/simulation/policy-rules.js?v=20260925-1';
