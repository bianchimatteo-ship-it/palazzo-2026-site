import { advanceDays } from './time.js?v=20260924-9';
import { ELECTION_MODELS } from '../data/simulation/campaign-rules.js?v=20260924-9';
import { activeMinisters, governingGroupIds, playerInMajority } from './parliament-engine.js?v=20260924-9';
import {
...
} from '../data/simulation/career-rules.js?v=20260924-9';
import { ACTIVITY_FINANCE_CATEGORY } from '../data/simulation/finance-rules.js?v=20260924-9';
import { ELECTED_CONTRIBUTION, SELECTION_LEAD_DAYS } from '../data/simulation/organization-rules.js?v=20260924-9';
import { ITALIAN_REGIONS } from '../data/regions.js?v=20260924-9';
import { book, createFinance, normalizeFinance, settleFinanceWeek } from './finance-engine.js?v=20260924-9';
import { advanceOrganization, applyOrgEffects, createOrganization, isPartyLeader, normalizeOrganization, treasuryBook } from './organization-engine.js?v=20260924-9';
import { advanceContacts, changeContact, contactLabel } from './contacts-engine.js?v=20260924-9';
