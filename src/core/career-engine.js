import { advanceDays, nextMunicipalVote, nextRegionalVote } from './time.js?v=20260926-6';
import { ELECTION_MODELS } from '../data/simulation/campaign-rules.js?v=20260926-6';
import { activeMinisters, governingGroupIds, playerInMajority } from './parliament-engine.js?v=20260926-6';
import {
  ...
  SITUATION_EVENTS, WEEKLY_ACTION_POINTS, WEEKLY_ACTIVITIES, PARTY_LINES, CURRENT_LINES, PARTY_INVESTMENTS, COMMUNICATION_STYLES, CURRENT_AREAS } from '../data/simulation/career-rules.js?v=20260926-6';
import { ACTIVITY_FINANCE_CATEGORY } from '../data/simulation/finance-rules.js?v=20260926-6';
import { ELECTED_CONTRIBUTION, SELECTION_LEAD_DAYS } from '../data/simulation/organization-rules.js?v=20260926-6';
...
import { book, buyInvestment, createFinance, depositElectionFund, hasAsset, normalizeFinance, settleFinanceWeek } from './finance-engine.js?v=20260926-6';
import { advanceOrganization, applyOrgEffects, createOrganization, isPartyLeader, normalizeOrganization, treasuryBook } from './organization-engine.js?v=20260926-6';
import { advanceContacts, changeContact, contactLabel } from './contacts-engine.js?v=20260926-6';
import { HARD_CATEGORIES, difficultyId, difficultyOf } from '../data/simulation/difficulty-rules.js?v=20260926-6';
import { macroAreaOf } from '../data/simulation/policy-rules.js?v=20260926-6';
import { advancementOdds, evaluateAdvancement, progressionFactors } from './progression-engine.js?v=20260926-6';
import { advanceCommittees, applyCommitteeAction, COMMITTEE_ACTIONS, COMMITTEE_LEVELS, COMMITTEE_STATES, foundCommittee } from './committee-engine.js?v=20260926-6';
import { europeanElectionDate, legislatureTerm, LEGISLATURE_RULES, sundayOnOrBefore } from './legislature-engine.js?v=20260926-6';
