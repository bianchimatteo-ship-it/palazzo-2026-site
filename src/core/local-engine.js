...
import { AREA_BY_ID, CAMP_PRIORITIES, POLICY_AREAS } from '../data/simulation/policy-rules.js?v=20260926-5';
import { cohesiveShare } from './parliament-engine.js?v=20260926-5';
import { groupLine, seededRandom, splitGroupVote } from './vote-engine.js?v=20260926-5';
