import { BUDGET_LINES, DEBT_CRISIS_THRESHOLD, DEBT_WEEKLY_INTEREST, ELECTION_FUND_MATCH, FINANCE_CATEGORIES, HISTORY_WEEKS, INVESTMENTS, LEDGER_SIZE, RESERVE_BEFORE_REPAYING } from '../data/simulation/finance-rules.js?v=20260925-1';
