...
import { CAMPAIGN_ACTIVITIES, DEBATE_TOPICS, ELECTION_MODELS, EUROPEAN_THRESHOLD } from '../data/simulation/campaign-rules.js?v=20260924-2';
import { runFinalElection, runFirstRound } from './election-engine.js?v=20260924-2';
import { ITALIAN_REGIONS } from '../data/regions.js?v=20260924-2';
