...
import { costProblem, nextPartyRank, partyAdvancementOdds, upcomingElections } from './career-engine.js?v=20260926-3';
import { activeMinisters, canManageParliament, CONTEST_COST, CONTEST_WINDOW_DAYS, governmentPostOdds, governmentPostProblems, nextParliamentaryRole, PARLIAMENTARY_ROLES } from './parliament-engine.js?v=20260926-3';
import { isPrimeMinister } from './roles.js?v=20260926-3';
import { PARTY_RANKS } from '../data/simulation/career-rules.js?v=20260926-3';
import { advancementOdds, progressionFactors } from './progression-engine.js?v=20260926-3';
import { formatDate } from './time.js?v=20260926-3';
