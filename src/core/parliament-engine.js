...
import { AREA_BY_ID, DECREE_RULES, FINANCING, GOVERNMENT_LINES, MINISTRIES, POLICY_AREAS, STAGE_WEEKS, areaOf } from '../data/simulation/policy-rules.js?v=20260925-7';
import { evaluateAdvancement } from './progression-engine.js?v=20260925-7';
import { groupLine, splitGroupVote } from './vote-engine.js?v=20260925-7';
