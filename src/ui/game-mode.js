import { activityProblem, CANDIDACY_RULES, costProblem, describeChoice, describeEffects, nextPartyRank, objectiveProgress, partyContestScore, situation, upcomingElections } from '../core/career-engine.js?v=20260924-22';
import { playerRoles } from '../core/roles.js?v=20260924-22';
import { activeMinisters, CHAMBERS, parliamentGroupFacts } from '../core/parliament-engine.js?v=20260924-22';
import { ACTIVITY_CATEGORIES, COMMUNICATION_STYLES, CURRENT_AREAS, PARTY_INVESTMENTS, PARTY_LINES, PARTY_RANKS, STAT_LABELS, WEEKLY_ACTIVITIES } from '../data/simulation/career-rules.js?v=20260924-22';
import { AREA_BY_ID, AREA_GROUPS, POLICY_AREAS } from '../data/simulation/policy-rules.js?v=20260924-22';
import { memoryBalance, MEMORY_KINDS } from '../core/career-engine.js?v=20260924-22';
import { careerLevelLabel } from '../data/regions.js?v=20260924-22';
import { formatDate } from '../core/time.js?v=20260924-22';
import { renderBarometerPanel } from './polls-mode.js?v=20260924-22';
import { artTile, CATEGORY_VISUALS, EVENT_ICONS, glyph, officeIcon } from './visuals.js?v=20260924-22';
import { ITALIAN_REGIONS } from '../data/regions.js?v=20260924-22';
import { societyMood } from '../core/society-engine.js?v=20260924-22';
import { financeOutlook } from '../core/finance-engine.js?v=20260924-22';
import { isPartyLeader, organOf } from '../core/organization-engine.js?v=20260924-22';
import { renderCountryCard, renderTerritoryCard } from './society-mode.js?v=20260924-22';
import { renderFinanceCard } from './finance-mode.js?v=20260924-22';
import { renderContactsPanel, renderPartyCard } from './organization-mode.js?v=20260924-22';
import { stateBadge } from './charts.js?v=20260924-22';
import { illustration } from './illustrations.js?v=20260924-22';
import { SEGMENTS } from '../data/simulation/society-rules.js?v=20260924-22';
import { regionPriorities } from '../core/society-engine.js?v=20260924-22';
