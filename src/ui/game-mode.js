import { activityProblem, costProblem, describeChoice, describeEffects, nextPartyRank, objectiveProgress, partyContestScore, situation, upcomingElections } from '../core/career-engine.js?v=20260924-14';
import { activeMinisters, CHAMBERS, parliamentGroupFacts } from '../core/parliament-engine.js?v=20260924-14';
import { ACTIVITY_CATEGORIES, PARTY_RANKS, STAT_LABELS, WEEKLY_ACTIVITIES } from '../data/simulation/career-rules.js?v=20260924-14';
import { careerLevelLabel } from '../data/regions.js?v=20260924-14';
import { formatDate } from '../core/time.js?v=20260924-14';
import { renderBarometerPanel } from './polls-mode.js?v=20260924-14';
import { artTile, CATEGORY_VISUALS, EVENT_ICONS, glyph, officeIcon } from './visuals.js?v=20260924-14';
import { ITALIAN_REGIONS } from '../data/regions.js?v=20260924-14';
import { societyMood } from '../core/society-engine.js?v=20260924-14';
import { financeOutlook } from '../core/finance-engine.js?v=20260924-14';
import { isPartyLeader, organOf } from '../core/organization-engine.js?v=20260924-14';
import { renderCountryCard, renderMediaPanel, renderTerritoryCard } from './society-mode.js?v=20260924-14';
import { renderFinanceCard } from './finance-mode.js?v=20260924-14';
import { renderContactsPanel, renderPartyCard } from './organization-mode.js?v=20260924-14';
import { stateBadge } from './charts.js?v=20260924-14';
...
import { regionPriorities } from '../core/society-engine.js?v=20260924-14';
