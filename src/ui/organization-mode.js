...
import { ORGANS, organOf, treasuryOutlook } from '../core/organization-engine.js?v=20260925-7';
import { affiliationOf, markForPerson } from './person-marks.js?v=20260925-7';
import { contactStance } from '../core/contacts-engine.js?v=20260925-7';
import { SELECTION_METHODS } from '../data/simulation/organization-rules.js?v=20260925-7';
...
import { esc, euro, levelState, lineChart, meter, num, SERIES, signed, sparkline, stateBadge, trendState } from './charts.js?v=20260925-7';
