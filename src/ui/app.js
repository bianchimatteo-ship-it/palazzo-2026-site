import { fullDate, formatDate } from '../core/time.js?v=20260924-10';
import { DATA_SOURCES, isSelectableParty } from '../data/schema.js?v=20260924-10';
import { isRealCollectionLoaded, loadRealCollections, pristineRecord, realDatabase, refreshAdminOverrides } from '../data/repositories/real-data.js?v=20260924-10';
import { addRoleOverride, clearAdminArchive, exportAdminArchive, hasAdminPin, importAdminArchive, isAdminUnlocked, lockAdmin, removeRoleOverride, resetRecordOverride, saveRecordOverride, setAdminPin, setRecordField, unlockAdmin } from '../data/repositories/admin-store.js?v=20260924-10';
import { renderAdminPanel } from './admin-panel.js?v=20260924-10';
import { deleteLocalLogo, exportLogoConfiguration, getLocalLogo, importLogoConfiguration, listLocalLogos, saveLocalLogo, validateLogoFile } from '../data/repositories/logo-store.js?v=20260924-10';
import { renderPartyArchive, renderPartyProfile } from './party-archive.js?v=20260924-10';
import { renderPoliticianArchive, renderPoliticianProfile } from './politician-archive.js?v=20260924-10';
import { renderLogoAdmin } from './logo-admin.js?v=20260924-10';
import { makeCareerDraft, renderCareerWizard } from './career-wizard.js?v=20260924-10';
import { validateCareerStep } from '../core/career-rules.js?v=20260924-10';
import { renderCampaignPage } from './campaign-mode.js?v=20260924-10';
import { renderParliamentPage } from './parliament-mode.js?v=20260924-10';
import { ELECTION_MODELS } from '../data/simulation/campaign-rules.js?v=20260924-10';
import { CAREER_LEVELS, careerLevelLabel } from '../data/regions.js?v=20260924-10';
import { renderElectionCalendar, renderHeadquarters, renderInbox, renderPartyPosition } from './game-mode.js?v=20260924-10';
import { attachChartInteractions, renderPollsPage } from './polls-mode.js?v=20260924-10';
import { glyph, officeIcon } from './visuals.js?v=20260924-10';
import { renderMediaPanel, renderTerritoriesPage } from './society-mode.js?v=20260924-10';
import { renderFinancePage } from './finance-mode.js?v=20260924-10';
import { renderContactsPanel, renderOrganizationPanel } from './organization-mode.js?v=20260924-10';
import { renderRealLaws } from './real-laws.js?v=20260924-10';
import { realLawArea } from '../core/society-engine.js?v=20260924-10';
import { canManageParliament } from '../core/parliament-engine.js?v=20260924-10';
