import { fullDate, formatDate } from '../core/time.js?v=20260926-3';
import { referenceGovernmentSpec } from '../data/repositories/government-reference.js?v=20260926-3';
import { accountApiBase, currentAccount, deleteCloudSave, downloadSave, knownRevision, listCloudSaves, login, logout, register, slotForCareer, uploadSave } from '../data/repositories/account-sync.js?v=20260926-3';
import { setPartyLogoResolver } from './person-marks.js?v=20260926-3';
import { DATA_SOURCES, isSelectableParty } from '../data/schema.js?v=20260926-3';
import { isRealCollectionLoaded, loadRealCollections, pristineRecord, realDatabase, refreshAdminOverrides } from '../data/repositories/real-data.js?v=20260926-3';
import { addAdminParty, addRoleOverride, clearAdminArchive, exportAdminArchive, importAdminArchive, loadSharedArchive, removeRoleOverride, resetRecordOverride, saveRecordOverride, setRecordField, setRecordHidden } from '../data/repositories/admin-store.js?v=20260926-3';
import { renderAdminPanel } from './admin-panel.js?v=20260926-3';
import { sharedLogos } from '../data/repositories/admin-store.js?v=20260926-3';
import { closeSharedSession, hasSharedSession, isAdminVerified, openSharedSession, publishSharedArchive, refreshSharedArchive, sharedApiUrl, verifySharedSession } from '../data/repositories/admin-sync.js?v=20260926-3';
import { deleteLocalLogo, exportLogoConfiguration, fetchLogoFromUrl, getLocalLogo, importLogoConfiguration, listLocalLogos, probeImage, saveLocalLogo, validateLogoFile } from '../data/repositories/logo-store.js?v=20260926-3';
import { renderPartyArchive, renderPartyProfile } from './party-archive.js?v=20260926-3';
import { renderPoliticianArchive, renderPoliticianProfile } from './politician-archive.js?v=20260926-3';
import { PARTY_LINK_COLLECTIONS } from '../data/repositories/party-links.js?v=20260926-3';
import { renderLogoAdmin } from './logo-admin.js?v=20260926-3';
import { chosenPlace, makeCareerDraft, renderCareerWizard, wizardLogoPreview } from './career-wizard.js?v=20260926-3';
import { userPartyLogo } from './party-logo.js?v=20260926-3';
import { CAREER_STEPS, validateCareerStep } from '../core/career-rules.js?v=20260926-3';
import { renderElectionsHub } from './elections-hub.js?v=20260926-3';
import { renderCareerPage } from './career-page.js?v=20260926-3';
import { renderPartyPage } from './party-page.js?v=20260926-3';
import { renderAgendaPage } from './agenda-page.js?v=20260926-3';
import { HEMICYCLE_DEFAULTS, renderHemicycle } from './hemicycle-view.js?v=20260926-3';
import { drawLogoEditor, exportLogo, measureBackground, panFromDrag, renderLogoEditor } from './logo-editor-view.js?v=20260926-3';
import { createEditorState } from '../core/logo-editor.js?v=20260926-3';
import { renderParliamentPage } from './parliament-mode.js?v=20260926-3';
import { ELECTION_MODELS } from '../data/simulation/campaign-rules.js?v=20260926-3';
import { CAREER_LEVELS } from '../data/regions.js?v=20260926-3';
import { renderHeadquarters } from './game-mode.js?v=20260926-3';
import { ARCHIVE_COLLECTIONS, renderArchiveBody, renderArchiveHub } from './archive-hub.js?v=20260926-3';
import { playerRoles } from '../core/roles.js?v=20260926-3';
import { budgetPreview, designFromForm, planFromForm, policyFields, policyPreview } from './policy-mode.js?v=20260926-3';
import { areaOf } from '../data/simulation/policy-rules.js?v=20260926-3';
import { attachChartInteractions, hideChartTip, renderPollsPage } from './polls-mode.js?v=20260926-3';
import { glyph } from './visuals.js?v=20260926-3';
import { renderMediaPanel, renderTerritoriesPage } from './society-mode.js?v=20260926-3';
import { renderFinancePage } from './finance-mode.js?v=20260926-3';
import { renderContactsPanel } from './organization-mode.js?v=20260926-3';
import { renderRealLaws } from './real-laws.js?v=20260926-3';
import { realLawArea } from '../core/society-engine.js?v=20260926-3';
import { canManageParliament } from '../core/parliament-engine.js?v=20260926-3';
import { renderConfirmDialog, renderMainMenu, renderWeeklyReport, settingsView, TOUR_STEPS } from './menu.js?v=20260926-3';
import { MAX_SLOTS } from '../core/storage.js?v=20260926-3';
import { loadSettings, resetSettings, saveSetting } from '../core/settings.js?v=20260926-3';
import { playSound } from './sound.js?v=20260926-3';
