import { activeMinisters, canManageParliament, CHAMBERS, CONTEST_COST, CONTEST_WINDOW_DAYS, GOVERNMENT_POST_REQUIREMENTS, governmentPostProblems, MINISTERIAL_PORTFOLIOS, nextParliamentaryRole, parliamentGroupFacts, playerInMajority } from '../core/parliament-engine.js?v=20260924-21';
import { DATA_SOURCES } from '../data/schema.js?v=20260924-21';
import { artTile, glyph, LAW_ICONS } from './visuals.js?v=20260924-21';
import { measureDesign, projectLaw } from '../core/society-engine.js?v=20260924-21';
import { governmentDesk, lawContent, policyFields, policyPreview } from './policy-mode.js?v=20260924-21';
