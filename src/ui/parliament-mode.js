import { activeMinisters, canManageParliament, CHAMBERS, CONTEST_COST, CONTEST_WINDOW_DAYS, LAW_CATEGORIES, MINISTERIAL_PORTFOLIOS, nextParliamentaryRole, parliamentGroupFacts, playerInMajority } from '../core/parliament-engine.js?v=20260924-7';
import { DATA_SOURCES } from '../data/schema.js?v=20260924-7';
import { artTile, LAW_ICONS } from './visuals.js?v=20260924-7';
