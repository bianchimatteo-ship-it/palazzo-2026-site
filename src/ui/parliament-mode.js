import { activeMinisters, canManageParliament, CHAMBERS, CONTEST_COST, CONTEST_WINDOW_DAYS, LAW_CATEGORIES, MINISTERIAL_PORTFOLIOS, nextParliamentaryRole, parliamentGroupFacts, playerInMajority } from '../core/parliament-engine.js?v=20260924-2';
import { DATA_SOURCES } from '../data/schema.js?v=20260924-2';
...
function governmentView(parliament, politicians = []) {
  const government = parliament.government;
...
function lawCard(law, parliament) {
  const canAct = canManageParliament(parliament);
