import { activeMinisters, canManageParliament, CHAMBERS, CONTEST_COST, CONTEST_WINDOW_DAYS, GOVERNMENT_POST_REQUIREMENTS, governmentPostProblems, MINISTERIAL_PORTFOLIOS, nextParliamentaryRole, parliamentGroupFacts, playerInMajority } from '../core/parliament-engine.js?v=20260925-1';
import { DATA_SOURCES } from '../data/schema.js?v=20260925-1';
import { artTile, glyph, LAW_ICONS } from './visuals.js?v=20260925-1';
import { measureDesign, projectLaw } from '../core/society-engine.js?v=20260925-1';
import { governmentDesk, lawContent, policyFields, policyPreview } from './policy-mode.js?v=20260925-1';
import { SEGMENTS } from '../data/simulation/society-rules.js?v=20260925-1';
