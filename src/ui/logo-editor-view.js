...
import { backgroundColor, cropRect, dominantColor, editorMetadata, frameAspect, knockOut, LOGO_EDITOR_LIMITS, outputSize, placement, untouched } from '../core/logo-editor.js?v=20260925-7';
