...
import { EP_GROUPS_2024, forecastAct, INSTITUTIONS, isClosedAct, LOCAL_VOTE_CHOICES, localAreas, majorityMargin } from '../core/local-engine.js?v=20260926-6';
import { AREA_BY_ID } from '../data/simulation/policy-rules.js?v=20260926-6';
import { esc, meter, num } from './charts.js?v=20260926-6';
