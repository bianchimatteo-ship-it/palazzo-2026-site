...
import { ADVANCEMENT_OUTCOMES } from '../core/progression-engine.js?v=20260926-8';
import { STAT_LABELS } from '../data/simulation/career-rules.js?v=20260926-8';
import { careerLevelLabel } from '../data/regions.js?v=20260926-8';
import { formatDate } from '../core/time.js?v=20260926-8';
import { glyph, officeIcon } from './visuals.js?v=20260926-8';
import { renderCareerTimeline, renderMemoryPanel, renderObjectivesPanel, renderRolesPanel, renderWhyPanel } from './game-mode.js?v=20260926-8';
import { arrow, badge, bar, card, empty, esc, num, sectionHero, sectionTabs, signed, table } from './sections-kit.js?v=20260926-8';
