import { ADMIN_FIELDS, POSITIONS, adminArchiveSummary, loadSharedArchive, overrideFor } from '../data/repositories/admin-store.js?v=20260925-8';
import { affiliationOf, markForPerson } from './person-marks.js?v=20260925-8';
import { hasSharedSession, sharedApiUrl } from '../data/repositories/admin-sync.js?v=20260925-8';
import { emblem, glyph } from './visuals.js?v=20260925-8';
