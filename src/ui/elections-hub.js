...
import { campaignSummary, strategyOf } from '../core/campaign-engine.js?v=20260926-1';
import { CAMPAIGN_PHASES, ELECTION_MODELS, SEAT_RULES } from '../data/simulation/campaign-rules.js?v=20260926-1';
import { PARTY_RANKS } from '../data/simulation/career-rules.js?v=20260926-1';
import { formatDate } from '../core/time.js?v=20260926-1';
import { societyMood } from '../core/society-engine.js?v=20260926-1';
import { renderCampaignPage } from './campaign-mode.js?v=20260926-1';
import { politicalPhase } from './game-mode.js?v=20260926-1';
import { lineChart, SERIES } from './charts.js?v=20260926-1';
import { glyph } from './visuals.js?v=20260926-1';
import { arrow, badge, bar, card, empty, esc, euro, kpi, num, pct, sectionHero, sectionTabs, signed, table, weeksLabel } from './sections-kit.js?v=20260926-1';
import { renderElectionReport } from './election-report.js?v=20260926-1';
import { renderNationalView } from './national-view.js?v=20260926-1';
