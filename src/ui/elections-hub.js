...
import { upcomingElections } from '../core/career-engine.js?v=20260925-6';
import { campaignSummary, strategyOf } from '../core/campaign-engine.js?v=20260925-6';
import { CAMPAIGN_PHASES, ELECTION_MODELS, SEAT_RULES } from '../data/simulation/campaign-rules.js?v=20260925-6';
...
import { renderCampaignPage } from './campaign-mode.js?v=20260925-6';
import { politicalPhase } from './game-mode.js?v=20260925-6';
import { lineChart, SERIES } from './charts.js?v=20260925-6';
import { glyph } from './visuals.js?v=20260925-6';
import { arrow, badge, bar, card, empty, esc, euro, kpi, num, pct, sectionHero, sectionTabs, signed, table, weeksLabel } from './sections-kit.js?v=20260925-6';
import { renderElectionReport } from './election-report.js?v=20260925-6';
