...
import { AGENDA_KINDS, agendaByMonth, agendaCalendar } from '../core/agenda-engine.js?v=20260925-6';
import { STAT_LABELS } from '../data/simulation/career-rules.js?v=20260925-6';
import { advanceDays, formatDate } from '../core/time.js?v=20260925-6';
import { glyph } from './visuals.js?v=20260925-6';
import { renderInbox, renderPlanner } from './game-mode.js?v=20260925-6';
import { arrow, badge, card, esc, euro, num, sectionHero, sectionTabs, signed, table } from './sections-kit.js?v=20260925-6';
