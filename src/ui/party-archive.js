...
import { BASIS_LABELS, POLITICAL_POSITIONS, electedOnListsOf, linkedPoliticians, politicianAffiliation } from '../data/repositories/party-links.js?v=20260926-6';
import { personMark } from './visuals.js?v=20260926-6';
