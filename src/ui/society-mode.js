...
import { INDICATORS, MEDIA_OUTLETS, SEGMENTS } from '../data/simulation/society-rules.js?v=20260924-19';
import { nationalIndicators, regionPriorities, societyMood } from '../core/society-engine.js?v=20260924-19';
import { illustration } from './illustrations.js?v=20260924-19';
import { artTile, glyph } from './visuals.js?v=20260924-19';
const weeks = count => `${count} ${count === 1 ? 'settimana' : 'settimane'}`;
import { breakdown, esc, levelState, lineChart, meter, num, rampColor, SERIES, signed, sparkline, stateBadge, trendState, GREEN_RAMP } from './charts.js?v=20260924-19';
import { areasPanel, publicFinancePanel, securityPanel } from './policy-mode.js?v=20260924-19';
