...
import { AREA_BY_ID, AREA_GROUPS, BILLION_PER_POINT, EU_DEFICIT_LIMIT, FINANCING, GOVERNMENT_LINES, INSTRUMENT_KINDS, INTENSITY, MINISTRIES, POLICY_AREAS, TERRITORIAL_TARGETS } from '../data/simulation/policy-rules.js?v=20260926-8';
...
import { areaTable, budgetImpact, measureDesign, projectMeasure } from '../core/society-engine.js?v=20260926-8';
import { activeMinisters, groupProfile, partnerSatisfaction, stageWait } from '../core/parliament-engine.js?v=20260926-8';
import { glyph } from './visuals.js?v=20260926-8';
import { esc, stateBadge } from './charts.js?v=20260926-8';
