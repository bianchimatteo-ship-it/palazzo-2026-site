import { mountApp } from './ui/app.js?v=20260924-6';
import { store } from './core/store.js?v=20260924-6';
import { loadRealCollections, loadRealDatabase } from './data/repositories/real-data.js?v=20260924-6';
